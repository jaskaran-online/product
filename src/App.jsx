...
function Home() {
  return (
    <div style={{ padding: "20px" }}>
      ...
      <p>
        Visit the <Link to="/dashboard">Dashboard</Link> to see nested routing
        with Outlet!
      </p>
      <h2>Lesson 6: Programmatic Navigation</h2>
      <p>
        Try the <Link to="/navigation-demo">Navigation Demo</Link> to see how to
        navigate programmatically!
      </p>
      <h2>Lesson 7: Search Parameters</h2>
      <p>
        Explore <Link to="/search-demo">Search Parameters Demo</Link> to learn
        about URL query strings!
      </p>
      <h2>Lesson 8: Route Protection</h2>
      <p>
        Check out <Link to="/protected-demo">Protected Routes Demo</Link> to
        learn about authentication and route guards!
      </p>
      <h2>Lesson 9: Error Handling</h2>
      <p>
        Explore <Link to="/error-demo">Error Boundaries Demo</Link> to learn
        about error handling and 404 pages!
      </p>
      <h2>Lesson 10: Loading States</h2>
      <p>
        Check out <Link to="/loading-demo">Loading States Demo</Link> to learn
        about async operations and loading UI!
      </p>
    </div>
  );
}
...
function NavigationDemo() {
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <p>
        This page demonstrates how to navigate programmatically using the
        useNavigate hook.
      </p>
      ...
      <button
        onClick={() =>
          navigate("/user/alice", { state: { from: "navigation-demo" } })
        }
        style={{ margin: "5px" }}
      >
...
function SearchParamsDemo() {
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <p>
        This page demonstrates how to work with URL query parameters using
        useSearchParams.
      </p>
      ...
      <h3>Quick Actions:</h3>
      <button
        onClick={() => setSearchParams({ name: "Alice" })}
        style={{ margin: "5px" }}
      >
        Set Name Only
      </button>
      <button
        onClick={() => setSearchParams({ city: "San Francisco" })}
        style={{ margin: "5px" }}
      >
        Set City Only
      </button>
  ...
  if (isAuthenticated) {
    return (
      <div style={{ padding: "20px" }}>
        ...
        <button
          onClick={() => navigate("/protected-demo/admin")}
          style={{ margin: "10px" }}
        >
          Go to Admin Panel
        </button>
...
function ProtectedRouteDemo() {
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <p>
        This page demonstrates route protection based on authentication status.
      </p>
      ...
      {isAuthenticated ? (
        <div>
          ...
          <p>
            Welcome to the admin panel! Only authenticated users can see this.
          </p>
          <div
            style={{
          ...
          >
            ...
            <p>
              Here you would see sensitive information, user management tools,
              etc.
            </p>
            <ul>
              <li>Manage users</li>
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      >
        ...
        <p>
          Click the button below to intentionally throw an error and see how the
  ...
  return (
    <div style={{ padding: "20px", textAlign: "center" }}>
      ...
      >
        <h3>💡 Pro Tip</h3>
        <p>
          This 404 page is created using a catch-all route (<code>*</code>) in
          React Router.
        </p>
        <p>
          It ensures users always see a helpful page instead of a blank screen.
        </p>
      </div>
    </div>
  );
      ...
      const mockData = {
        ...
        posts: [
          { id: 1, title: "Learn React", content: "React is awesome!" },
          {
            ...
            content: "Routing made easy!",
          },
          {
            id: 3,
            title: "Build Great UIs",
  ...
  return (
    <div style={{ marginBottom: "20px" }}>
      ...
      <div style={{ marginBottom: "15px" }}>
        ...
        <button
          onClick={() => fetchData("slow")}
          style={{ marginRight: "10px" }}
        >
          Load Slow (3s)
        </button>
        <button
          onClick={() => fetchData("fast")}
          style={{ marginRight: "10px" }}
        >
          Load Fast (0.5s)
        </button>
...
function LoadingStatesDemo() {
  return (
    <div style={{ padding: "20px" }}>
      ...
      <p>
        This page demonstrates various loading states and async operations in
...
function UserProfile() {
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <p>
        This is {username}'s profile page. The username is extracted from the
        URL!
      </p>

      <h3>Profile Actions:</h3>
      <button
        onClick={() => navigate("/", { state: { from: `user-${username}` } })}
        style={{ margin: "5px" }}
      >
        Go Home with State
      </button>
